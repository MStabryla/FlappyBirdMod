...
BIRD_IMGS = [pygame.image.load('Game Images/Flappy Bird.png'),
             pygame.image.load('Game Images/Flappy Bird Wings Up.png'),
             pygame.image.load('Game Images/Flappy Bird Wings Down.png')]
BOTTOM_PIPE_IMG = pygame.image.load('Game Images/Super Mario pipe.png')
